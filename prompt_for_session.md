Tôi là sinh viên đang học khóa học "AI in Production", và chúng ta đang làm việc trong repo của khóa học.
...
* Tôi đang ở `guides/5_database.md` và đã hoàn thành xong các guide trước đó 

Bạn cũng có thể xem qua: `backend/*/README.md` và `terraform/*/README.md` chứa mô tả của mỗi folder mà tôi đã thực hiện qua nếu thấy cần thiết.
